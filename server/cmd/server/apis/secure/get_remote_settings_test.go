...
// 	defer cancel()
// 	addUser(ctx, t, q, 123)
// 	err := q.AddLogin(ctx, sql_queries.AddLoginParams{LoginUuid: uuid.New().String(), UserID: 123, DeviceDescription: "Description", Created: 123, IndexID: 123321})
// 	if err != nil {
// 		t.Fatal("cant create login", err)
// 	}
// 	addQuestion(ctx, t, q, 123, 321)
// 	server := secure.Server{Db: q, OrigDB: db}
// 	res, err := secure.GetRemoteSettings(context.WithValue(ctx, secure.TokenID, "123"), 123, server, map[string]any{})
